...
Проведение экспериментов с методом выбора аугментации после каждой эпохи. Результаты представлены ниже:


1. 'TimeCycleShift', 'Noise', 'TimeRandomSwap', 'FreqMasking'

| Метод аугментации       | R18 + AM        | R50 + AM       | R18 + AM        | R50 + AM       |
| ---------------------   |:---------------:| --------------:|:---------------:| --------------:|
| No augmentation         | 0.951 \pm 0.012 | 0.83           | 0.851           | 0.83           |
| Random сhoice           | 0.848           | 0.84           | 0.848           | 0.84           |
| Choice after each epoch | 0.848           | 0.84           | 0.848           | 0.84           |
| Frequency random choice | 0.863           | 0.807          | 0.848           | 0.84           |
